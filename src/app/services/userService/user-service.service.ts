...
export class UserServiceService {
  ...
  postUser(userModel: UserModel): Observable<any>{
    return this.http.post<any>(`${this.url}/users`, {
      ...
      mind_university: userModel.mind_university,
      mind_teams: userModel.mind_teams,
      date_entry_mind_u: userModel.date_entry_mind_u,
      date_entry_mind_teams:  userModel.date_entry_mind_u,
      days_mind_u: userModel.days_mind_u,
      days_mind_t:  userModel.days_mind_u,
